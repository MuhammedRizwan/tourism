export default function BannerHeader() {
  return (
    <div className="absolute top-70 z-30 max-w-3xl mx-5 md:mx-20">
      <h1 className="text-2xl md:text-4xl font-serif leading-tight font-light mb-4">
        <span className="block">Step Into a</span>
        <span className="block">World of Discovery</span>
      </h1>
      <p className="hidden md:block mt-4 text-sm md:text-md text-gray-200 font-light mb-10">
